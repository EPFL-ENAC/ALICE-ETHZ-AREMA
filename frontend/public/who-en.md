...
The Atlas of Regenerative Materials emerged from a shared recognition that the transition toward regenerative construction depends not only on innovation, but on making existing knowledge visible, situated, and accessible.
The initial group gathered around the Chair of Sustainable Construction at ETH Zurich including Shoshana Huber (mechanical engineer and craftswoman), Alia Bengana (architect, educator and author, Villa Medici fellow 2025–2026), Yannick Marcon (web developer at EPFL ENAC-IT4R), and the design team Undo-Redo.
...
<p class="q-mt-lg">
  ...
  <a href="https://www.dist.polito.it/" target="_blank">
    ...
    <img width="599" height="143" alt="Image" src="https://github.com/user-attachments/assets/1d98f505-746c-46d9-bed9-eb1dcd2acf9e" />
  </a>
