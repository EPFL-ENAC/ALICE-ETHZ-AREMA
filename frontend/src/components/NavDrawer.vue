<template>
  <div>
    <q-btn :disable="home" to="/" no-caps size="48px" :label="$t('home')" class="full-width" align="left" />
    <q-separator class="bg-primary" size="2px" />
    <div style="font-size: 48px; font-weight: 500; line-height: 1.715em" class="q-ml-md q-pt-md">
      {{ $t('atlas') }}
    </div>
    ...
    <q-separator class="bg-primary" size="2px" />
    <q-btn to="/contact" no-caps size="48px" :label="$t('contact')" class="full-width" align="left" />
  </div>
</template>
