...
export const professionalDataSchema = Type.Pick(
  professionalSchema,
  ['name', 'description', 'address', 'images', 'areaDelivery'],
  {
    $id: 'ProfessionalData'
  }
)
...
export const professionalQueryProperties = Type.Pick(professionalSchema, ['id', 'name', 'description', 'address', 'areaDelivery'])
