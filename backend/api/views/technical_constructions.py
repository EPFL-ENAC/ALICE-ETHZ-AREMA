...
async def assign(
    ...
    return await TechnicalConstructionService(session).set_assignee(id, assignee, user)
...
async def unassign(
    ...
    return await TechnicalConstructionService(session).set_assignee(id, None, user)
