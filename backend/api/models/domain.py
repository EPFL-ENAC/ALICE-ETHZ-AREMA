...
class BuildingMaterialNaturalResource(SQLModel, table=True):
  building_material_id: Optional[int] = Field(default=None, foreign_key="buildingmaterial.id", primary_key=True)
  natural_resource_id: Optional[int] = Field(default=None, foreign_key="naturalresource.id", primary_key=True)

class TechnicalConstructionBuildingMaterial(SQLModel, table=True):
  technical_construction_id: Optional[int] = Field(default=None, foreign_key="technicalconstruction.id", primary_key=True)
  building_material_id: Optional[int] = Field(default=None, foreign_key="buildingmaterial.id", primary_key=True)

class BuildingBuildingMaterial(SQLModel, table=True):
  building_id: Optional[int] = Field(default=None, foreign_key="building.id", primary_key=True)
  building_material_id: Optional[int] = Field(default=None, foreign_key="buildingmaterial.id", primary_key=True)
...
class ProfessionalBuilding(SQLModel, table=True):
  professional_id: Optional[int] = Field(default=None, foreign_key="professional.id", primary_key=True)
  building_id: Optional[int] = Field(default=None, foreign_key="building.id", primary_key=True)
...
class NaturalResource(NaturalResourceBase, table=True):
  ...
  building_materials: List["BuildingMaterial"] = Relationship(back_populates="natural_resources", link_model=BuildingMaterialNaturalResource)
...
class BuildingMaterial(BuildingMaterialBase, table=True):
  ...
  natural_resources: List["NaturalResource"] = Relationship(back_populates="building_materials", link_model=BuildingMaterialNaturalResource)
  technical_constructions: List["TechnicalConstruction"] = Relationship(back_populates="building_materials", link_model=TechnicalConstructionBuildingMaterial)
  buildings: List["Building"] = Relationship(back_populates="building_materials", link_model=BuildingBuildingMaterial)
  professionals: List["Professional"] = Relationship(back_populates="building_materials", link_model=ProfessionalBuildingMaterial)
...
class TechnicalConstruction(TechnicalConstructionBase, table=True):
  ...
  building_materials: List["BuildingMaterial"] = Relationship(back_populates="technical_constructions", link_model=TechnicalConstructionBuildingMaterial)
  professionals: List["Professional"] = Relationship(back_populates="technical_constructions", link_model=ProfessionalTechnicalConstruction)
  buildings: List["Building"] = Relationship(back_populates="technical_constructions", link_model=BuildingTechnicalConstruction)
...
class Building(BuildingBase, table=True):
  ...
  building_materials: List["BuildingMaterial"] = Relationship(back_populates="buildings", link_model=BuildingBuildingMaterial)
  professionals: List["Professional"] = Relationship(back_populates="buildings", link_model=ProfessionalBuilding)
  technical_constructions: List["TechnicalConstruction"] = Relationship(back_populates="buildings", link_model=BuildingTechnicalConstruction)
...
class Professional(ProfessionalBase, table=True):
  ...
  buildings: List["Building"] = Relationship(back_populates="professionals", link_model=ProfessionalBuilding)
  building_materials: List["BuildingMaterial"] = Relationship(back_populates="professionals", link_model=ProfessionalBuildingMaterial)
  technical_constructions: List["TechnicalConstruction"] = Relationship(back_populates="professionals", link_model=ProfessionalTechnicalConstruction)
