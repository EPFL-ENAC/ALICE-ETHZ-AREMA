...
const user = (app) => {
    ...
    app.use(users_shared_1.userPath, new users_class_1.UserService((0, users_class_1.getOptions)(app)), {
        ...
        docs: (0, feathers_swagger_1.createSwaggerServiceOptions)({
            schemas: { userSchema: users_schema_1.userSchema, userDataSchema: users_schema_1.userDataSchema, userPatchSchema: users_schema_1.userPatchSchema, userQuerySchema: users_schema_1.userQuerySchema },
            docs: {
