...
export default {
  ...
  roles_hint:
    'Un contributeur peut créer et modifier ses propres éléments, un réviseur peut modifier tous les éléments mais ne peut pas les publier, et un administrateur peut effectuer toutes les opérations, y compris la gestion des utilisateurs.',
