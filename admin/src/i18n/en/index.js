export default {
  ...
  profile: {
    current: 'My profile',
    current_hint: 'Your profile information is publicly visible as an author.',
    identifier: 'Identifier',
    type: 'Type',
    name: 'Display name',
    affiliation: 'Affiliation',
    affiliation_hint: 'Your organization or affiliation.',
    description: 'Description',
    description_hint: 'Short bio or description about yourself.',
    email: 'Public email',
  ...
  unsaved_changes_confirm: 'You have unsaved changes. Discard them and close the form?',
  class: 'Class',
  classic: 'Classic',
  client: 'Client',
  close: 'Close',
  ...
  copyright_confirmation: 'I confirm hereby that I have the rights to publish all data in this form, photos included.',
  created_by: 'Added by',
  created_by_me: 'Added by me',
  credits: 'Credits',
  dashboard: 'Dashboard',
  decorate: 'Decorate',
  decorate_hint: 'Enrich text with terminology entries.',
  density_hint: 'ρ, kg/m³',
  density: 'Density',
  description: 'Description',
  diff: 'Diff',
  ...
  snapshot: 'Snapshot',
  snapshot_help: 'Download a snapshot of the current published data for further reference.',
  snapshot_download: 'Download snapshot',
  snapshot_download_error: 'Snapshot download error',
  ...
  terms_and_conditions_reminder: 'Note that by saving you stay author of your article but give ETH Zürich the rights to publish it under the license CC BY-SA 4.0.',
